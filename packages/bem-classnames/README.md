...
## Documentation
Learn more in the [Documentation](https://github.com/rhapsodic-dev/bem-classnames/blob/master/docs/docs.md).

## Agent skills

This repository includes provider-agnostic agent skills in [`skills`](https://github.com/rhapsodic-dev/bem-classnames/tree/master/skills).
...
[MIT License](https://github.com/rhapsodic-dev/bem-classnames/blob/master/LICENSE)
